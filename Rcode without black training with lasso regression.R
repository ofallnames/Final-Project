...
library(readr)
# Read the CSV file
data <- read_csv("C:/Users/Thomas/Desktop/boston-housing/train_wo_black.csv")
library(caret)
data <- data[, -1]
...
neural_network <- neuralnet(formula, data = training_data, hidden = c(20, 10)) # You can adjust the number of hidden layers and neurons as needed
...
# Make predictions on the testing set
lasso_predictions <- predict(lasso_model, newx = as.matrix(test_data4[, 0:12]), s = "lambda.min")
